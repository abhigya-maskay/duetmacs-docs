...
## Inputs & References
- Epic: [[03-Epics/V1-Foundation/01-Project-Bootstrap/Stories/001-cli-version-help-bootstrap/001-cli-version-help-bootstrap]]
- UX: [[03-Epics/V1-Foundation/01-Project-Bootstrap/Stories/001-cli-version-help-bootstrap/ux]]
- Components: CLIParser, HelpFormatter, OutputFormatter, Logger, VersionManager, ErrorHandler, ConfigLoader.
- Architecture: [[01-Architecture/duet-rpc/duet-rpc Technical Architecture|duet-rpc Technical Architecture]] (Haskell + Cabal; optparse-applicative; tasty/hedgehog).
...
- E2E | P1 | `DUET_RPC_LOG` invalid path → logger falls back to stderr with a warning; command output unaffected.
