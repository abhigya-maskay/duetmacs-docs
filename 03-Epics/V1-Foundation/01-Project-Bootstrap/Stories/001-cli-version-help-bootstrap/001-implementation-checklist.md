...
- [x] 7. Add Config skeleton (constants only)
...
- [x] 8. Ensure newline-terminated outputs everywhere
...
- [x] 9. Test suite scaffolding and golden setup
...
- [x] 10. Optional TTY color test (platform-gated)
...
- [x] 11. Unit tests for pure components
